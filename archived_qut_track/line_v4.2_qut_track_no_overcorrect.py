...
def stabilize(current, new, num_lanes, max_confident_deviation=1,max_unsure_deviation=0.5):
	"""
	...
	if num_lanes == 2:
		...
		max_angle_deviation = max_confident_deviation * scale
	elif num_lanes == 1:
		# if only one lane detected, don't deviate too much
		max_angle_deviation = max_unsure_deviation * scale
	else:
